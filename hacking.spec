...
%prep
%setup -q -n hacking-3.2.0
cd %{_builddir}/hacking-3.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1596052070
...
cp %{_builddir}/hacking-3.2.0/LICENSE %{buildroot}/usr/share/package-licenses/hacking/294b43b2cec9919063be1a3b49e8722648424779
